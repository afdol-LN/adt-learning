...
export class UpdateSchem1785053410502 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE SEQUENCE IF NOT EXISTS "skill_skill_id_seq" OWNED BY "skill"."skill_id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "skill" ALTER COLUMN "skill_id" SET DEFAULT nextval('"skill_skill_id_seq"')`,
    );
    await queryRunner.query(
      `SELECT setval('"skill_skill_id_seq"', COALESCE((SELECT MAX("skill_id") FROM "skill"), 0) + 1, false)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "skill" ALTER COLUMN "skill_id" DROP DEFAULT`,
    );
